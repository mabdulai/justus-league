...
heroImage: '../../assets/images/lmop.jpeg'
---

import { Image } from 'astro:assets';
import wagon from '@assets/images/session1-wagon.png';
import wolf from '@assets/images/session1-wolf.png';
...
Twee dode paarden op de trail waren lokaas voor een ambush. 4 gevaarlijke goblins vielen de groep aan. Met een uitzonderlijke voltreffer kregen ze Nedsie neer. De rest van de groep vernietigde de goblins, mede door een double kill van <CharacterPopper character="ithil" client:load>Ithil</CharacterPopper> haar Ice Daggers.
